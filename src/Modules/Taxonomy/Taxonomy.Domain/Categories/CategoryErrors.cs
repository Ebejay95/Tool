...
public static class CategoryErrors
{
    ...
    public static readonly Error AccessDenied      = new("Category.AccessDenied",    "Keine Berechtigung für diese Kategorie.");
    public static readonly Error GlobalReadOnly    = new("Category.GlobalReadOnly",  "Globale Kategorien können nicht bearbeitet werden.");
}
