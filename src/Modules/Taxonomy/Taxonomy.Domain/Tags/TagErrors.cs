...
public static class TagErrors
{
    ...
    public static readonly Error AccessDenied      = new("Tag.AccessDenied",    "Keine Berechtigung für diesen Tag.");
    public static readonly Error GlobalReadOnly    = new("Tag.GlobalReadOnly",  "Globale Tags können nicht bearbeitet werden.");
}
